...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Nicolas Lemoine"
    user-mail-address "nico.lemoine@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/nico/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/nico/bin" "/profile/bin" "/Users/nico/.npm-packages/bin" "/Users/nico/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
